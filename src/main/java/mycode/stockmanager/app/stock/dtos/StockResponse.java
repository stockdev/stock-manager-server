...
@Builder
public record StockResponse(Long id, Location location, Article article, StockType stockType, SubStockType subStockType, int orderNumber, int quantity, int necessary, LocalDateTime transactionDate, String comment) {
}
